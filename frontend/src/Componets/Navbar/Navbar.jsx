...
function Navbar() {
  ...
  return (
    <div>
      ...
      {isDivVisibleForJob && (
        <div
          className="profile-dropdown-1"
          onMouseEnter={showJobs}
      ...
      <div className="login">
        {isDivVisibleForlogin && !user && (
          <>
            <button id="cross" onClick={closeLogin}>
              <i className="bi bi-x"></i>
            </button>
            <h5 id="state" className="justify-center text-center">
              <span
                id="Sign-in"
                  ...
                  <div className="flex bg-white rounded-lg justify-center overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
                    <div className="w-full p-8 lg:w-full">
                      <div
                        ...
                        className="flex
 items-center h-9 justify-center text-white bg-slate-100 rounded-lg hover:bg-gray-100"
                      >
                        <div className="px-4">
                        ...
                        <h4 className="text-gray-500">Sign in With Google</h4>
                      </div>
        ...
        {isDivVisibleForProfile && (
          <div className="profile-dropdown h-6 rounded-sm shadow-sm">
