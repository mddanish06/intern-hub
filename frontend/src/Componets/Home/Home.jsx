...
function Home() {
  ...
  return (
    <>
      ...
      <p className="text-center text-lg font-bold">Trending on InternHub 🔥</p>
        ...
        <div className="info-intern">
          <div className="mt-16">
            <h1 className="text-center font-bold">
              Latest internships on InternHub
            </h1>
          </div>
      ...
      <div className="logins flex  h-32 mt-8">
        <div className="cont">
          <p className="flex justify-center text-white text-xl items-center m-5 w-30">
            Empower your career with InternHub today
          </p>
        </div>
        <div className="log flex">
          ...
          >
            ...
            <h3 className="px-4 py-3 w-5/6 text-center text-sm text-gray-600 font-bold ">
              Sign in with Google
            </h3>
          </button>
          <Link to="/register">
